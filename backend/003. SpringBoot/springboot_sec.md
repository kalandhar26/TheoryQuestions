...
# 2. An API is fast in dev but slow in production? How do you trace the root cause?
...
# 7. Database connection pool is exhausted? How do you detect and fix the issue?
...
# 10. Logs are missing in production but looks fine locally? WHat are your first checks?
